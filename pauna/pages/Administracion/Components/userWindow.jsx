...
export default function UserWindow() {
    ...
    return (
        <div className="bg-white sm:h-screem">
            <div className="flex bg-[#D9D9D9] m-5 p-20 rounded-lg">
                    ...
                    <div className="h-screen p-20">
                        <div className="bg-white text-center text-2xl font-semibold w-max h-max p-10 rounded-lg ">
                            ...
                            <div className={`bg-white text-center flex items-center justify-center p-5`}>
                                ...
                                <select className="bg-[#989898] rounded-lg p-5 text-white text-center" type="">
                                    <option className="text-white text-center" value="manzana">Administrador</option>
                                    <option className="text-white text-center" value="man">Ad</option>
                                </select>
                            </div>
