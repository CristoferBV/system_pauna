...
export default function Sidebar() {
    return (
        <>
            <div className="lg:w-1/5 bg-[#021730] shadow-inner text-white min-h-screen fixed left-0 top-0">
                ...
                <ul className="flex-grow mt-4 lg:mt-10 space-y-2 lg:space-y-4">
                    ...
                    <Link href={"/Biblioteca/Administrador/Components/InterfazAdminBiblioteca/Horario"}>
                        <li className="py-2 lg:py-4 pl-4 lg:pl-20 transition ease-in-out delay-140 bg-[#021730] hover:bg-[#132335] hover:-translate-y-1 hover:scale-105 duration-200">
                    ...
                    <Link href={"/LoginAndRegister/Login/Login"}>
                        <li>
                            <button className='ml-2 lg:ml-16 text-white border-white lg:mt-20 w-24 lg:w-32 h-8 lg:h-10 bg-[#132335] hover:bg-[#c43f3f]'>Cerrar Sesión</button>
                        </li>
                    </Link>
                </ul>
            </div>
